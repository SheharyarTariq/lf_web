...
function SectionHeader({ label, heading }: { label: string; heading: React.ReactNode }) {
  return (
    <>
      <div className="text-[10px] font-bold tracking-[2.5px] uppercase text-muted mb-2 text-center">
        {label}
      </div>
      <h2 className="text-[clamp(26px,3.5vw,38px)] font-extrabold tracking-[-1.2px] leading-[1.1] text-dark mb-10 text-center">
        {heading}
      </h2>
    </>
  );
  ...
  return (
    <>
      ...
      <section className="bg-dark pt-16 px-12 pb-[60px] text-center relative overflow-hidden max-[860px]:pt-[52px] max-[860px]:px-5 max-[860px]:pb-12">
        ...
        <h1 className="relative z-10 text-[clamp(40px,6vw,68px)] font-extrabold leading-none tracking-[-2.5px] text-white mb-4">
          Clean <em className="text-lime not-italic">laundry.</em>
          <br />
      ...
      {/* ── STATS ── white bg with top+bottom border */}
      <div className="bg-white border-y border-lf-border">
        <div className="max-w-[1080px] mx-auto pt-10 px-12 text-center max-[860px]:px-5">
          <div className="text-[10px] font-bold tracking-[2.5px] uppercase text-muted mb-2">
            By the numbers
          </div>
          <h2 className="text-[clamp(26px,3.5vw,38px)] font-extrabold tracking-[-1.2px] leading-[1.1] text-dark text-center">
            Why LaundryFree
          </h2>
        </div>
        <div className="max-w-[1080px] mx-auto px-12 grid grid-cols-3 max-[860px]:px-5 max-[540px]:grid-cols-1">
          {/* Stat 1 */}
          <div className="py-10 px-8 border-r border-lf-border flex flex-col gap-1 items-center text-center max-[860px]:py-6 max-[860px]:pl-4 max-[860px]:pr-0 max-[540px]:border-r-0 max-[540px]:border-b max-[540px]:border-lf-border max-[540px]:py-6 max-[540px]:px-0">
            ...
            <p className="text-[12px] text-muted">Collection &amp; delivery cost</p>
          </div>
          {/* Stat 2 */}
          <div className="py-10 px-8 border-r border-lf-border flex flex-col gap-1 items-center text-center max-[860px]:py-6 max-[860px]:pl-4 max-[860px]:pr-0 max-[540px]:border-r-0 max-[540px]:border-b max-[540px]:border-lf-border max-[540px]:py-6 max-[540px]:px-0">
            <h3 className="text-[clamp(30px,3.5vw,42px)] font-extrabold tracking-[-1.5px] text-dark">
            ...
            <p className="text-[12px] text-muted">To place your first order</p>
          </div>
          ...
          <div className="py-10 px-8 flex flex-col gap-1 items-center text-center max-[860px]:py-6 max-[860px]:pl-4 max-[860px]:pr-0 max-[540px]:py-6 max-[540px]:px-0">
            ...
            <p className="text-[12px] text-muted">Available on both platforms</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <h2 className="text-[clamp(26px,3.5vw,38px)] font-extrabold tracking-[-1.2px] leading-[1.1] text-dark mb-[10px] text-center">
          Download the app
        </h2>
        <p className="text-[15px] text-black/55 mb-9">
