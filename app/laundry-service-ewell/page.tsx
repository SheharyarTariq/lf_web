...
export const metadata: Metadata = {
  title: "Laundry Service Ewell — Free Collection & Delivery | Laundry Free",
  description:
    "Professional laundry collection and delivery in Ewell (KT17, KT19). We pick up your laundry, professionally clean it and deliver it back — collection and delivery always free. Book via app.",
  alternates: { canonical: "/laundry-service-ewell" },
  openGraph: {
    title: "Laundry Service Ewell — Free Collection & Delivery | Laundry Free",
    description:
      "Professional laundry collection and delivery in Ewell KT17, KT19. Free pickup & delivery. Book via the Laundry Free app.",
    url: "https://www.laundryfree.co.uk/laundry-service-ewell",
  },
};
...
const schema = {
  ...
  "@type": "LaundryService",
  name: "Laundry Free — Ewell",
  url: "https://www.laundryfree.co.uk/laundry-service-ewell",
  description: "Professional laundry collection and delivery service in Ewell, KT17 and KT19, Surrey.",
...
export default function LaundryServiceEwell() {
  return (
    <>
      <script
      ...
      <main className="flex-1">
        <section className="bg-dark pt-16 pb-14 px-12 text-center max-[860px]:pt-12 max-[860px]:px-5 max-[860px]:pb-10">
          <div className="text-[11px] font-bold tracking-[3px] uppercase text-lime/70 mb-3">Ewell · KT17 · KT19</div>
          <h1 className="text-[clamp(32px,5vw,56px)] font-extrabold leading-none tracking-[-2px] text-white mb-5">
            Laundry Service in <em className="text-lime not-italic">Ewell</em>
          </h1>
          <p className="text-[16px] text-white/55 max-w-[520px] mx-auto mb-8 leading-[1.65]">
            Laundry Free serves Ewell with a complete door-to-door laundry collection and delivery service. Hand over your laundry, we clean it professionally, and return it folded to your door — all with free collection and delivery.
          </p>
        ...
        <section className="bg-white py-16 px-12 max-[860px]:py-12 max-[860px]:px-5">
          <div className="max-w-[860px] mx-auto">
            ...
            <h2 className="text-[clamp(26px,3.5vw,36px)] font-extrabold tracking-[-1.2px] text-dark mb-8">
              Simple laundry collection for Ewell residents
            </h2>
            <div className="grid grid-cols-3 gap-6 max-[640px]:grid-cols-1">
              {[
                { n: "1", title: "Book your Ewell pickup", body: "Download the Laundry Free app, select a collection slot and we'll come to your Ewell address — KT17 or KT19 — at the time you choose." },
                { n: "2", title: "We take it from there", body: "No preparation needed. We collect your laundry, identify and log every item, and clean each one to its care label. You'll see the full list in the app." },
                { n: "3", title: "Clean clothes returned fast", body: "Your laundry is back at your door within 48 hours, neatly folded. Free delivery on every order, no minimum size." },
              ].map((step) => (
        ...
        <section className="bg-lf-bg py-16 px-12 max-[860px]:py-12 max-[860px]:px-5">
          <div className="max-w-[860px] mx-auto">
            <h2 className="text-[clamp(22px,3vw,30px)] font-extrabold tracking-[-1px] text-dark mb-6">
              Why Ewell residents choose Laundry Free
            </h2>
            <div className="grid grid-cols-2 gap-5 max-[540px]:grid-cols-1">
              {[
                { title: "Always free collection & delivery", body: "There is no charge for us coming to your Ewell address to pick up or drop off. Collection and delivery are free on every order, always." },
                { title: "No sorting required", body: "Pass your laundry over as it is — mixed, unsorted, in any bag. We handle all the itemising and sorting at our facility." },
                { title: "Approve before you pay", body: "Enable Price Review in the app and confirm every charge before payment. Nothing is taken without your approval." },
                { title: "Set recurring pickups", body: "Automate your laundry routine with recurring collections in Ewell. Pause or cancel at any time without penalty." },
              ].map((item) => (
        ...
        <section className="bg-lime py-14 px-12 text-center max-[860px]:py-10 max-[860px]:px-5">
          <h2 className="text-[clamp(22px,3vw,32px)] font-extrabold tracking-[-1px] text-dark mb-3">
            Ready to book your first Ewell laundry pickup?
          </h2>
