...
export default function RequestDeletion() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    /* The staging host used to be hardcoded here, so this form posted to
       staging from production too. It goes through config.apiUrl now, like
       everything else. */
    const res = await apiCall({
      endpoint: routes.api.requestDeletion,
      method: "POST",
      data: { email: email.trim() },
      headers: { "Content-Type": "application/json", Accept: "application/json" },
      /* The form renders its own success and error states inline. */
