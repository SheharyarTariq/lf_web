...
import { ASSETS, BRAND, HERO_SLOTS, RATING, TOWNS } from "@/lib/content";
import { btn } from "@/lib/button";
import { usePrefersReducedMotion, useStartBooking, useTypewriter } from "@/lib/hooks";
        ...
        <div>
          ...
          >
            ...
            <div className="flex gap-2.5 to-720:flex-col">
              <button type="submit" className={btn({ block: true })}>
                Check availability
              </button>
            </div>
          </form>
