...
import { CLOSE_BTN } from "@/components/booking/parts";
import { routesFor, stepsFor, type Route } from "@/lib/booking/flow";
  ...
  return (
    <footer className="bg-white to-720:hidden">
      <div className="mx-auto flex max-w-wrap flex-wrap items-center gap-x-[18px] gap-y-2 px-6 py-5 text-[13px] text-bk-ink-3 to-400:px-4">
        ...
        <a className="no-underline hover:underline" href="/terms">
          Terms
        </a>
        <a className="no-underline hover:underline" href="/privacy-policy">
          Privacy
        </a>
