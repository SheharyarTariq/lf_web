...
import { Field, Modal, MODAL_FOOT, MODAL_NAV, MODAL_NAV_BTN } from "@/components/booking/parts";
import { verifyCode, signInWith } from "@/lib/booking/mocks";
import {
  CODE_LENGTH,
  EMAIL_RE,
  RESEND_SECONDS,
...
import { bkBtn, BTN_LINK, CODE_INPUT, INPUT, SEC_H, SEC_P } from "@/lib/booking/styles";
import { BRAND, FAQ, FAQ_PREVIEW_COUNT } from "@/lib/content";
...
/* ── FAQs ─────────────────────────────────────────────────────────
   ...
   from the same array in @/lib/content — nine answers duplicated across
