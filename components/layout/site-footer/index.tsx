...
import { BRAND, FOOTER } from "@/utils/content";
                ...
                <ul>
                  {links.map(([label, href]) => (
                    <li key={label} className="mb-2.5">
                      {/* Every entry is a <Link>, including the "/#pricing"
                          style ones. They used to be raw anchors, which meant
                          jumping to a landing-page section from the footer of
                          any other page reloaded the whole document. */}
                      <Link
                        href={href}
